...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper_custom">
        ...
        <div class="flash-container">
            <?php if(isset($_SESSION['identity_success'])){?>
            <div class="alert alert-success text-center" id="success_message_div" style="margin-bottom:0px;"
                role="alert">
                <a href="#" style="float:right;" class="alert-close" data-dismiss="alert">&times;</a>
                <p id="success_message"><?php echo $_SESSION['identity_success'];?></p>
            </div>
            <?php UnsetSession('identity_success');}?>
            <?php if(isset($_SESSION['identity_error'])){?>
            <div class="alert alert-danger text-center" id="error_message_div" style="margin-bottom:0px;" role="alert">
                ...
                <p id="error_message"><?php echo $_SESSION['identity_error'];?></p>
            </div>
            <?php }?>
        </div>
        <!-- /.Flash Message  -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="panel-title text-bold ml-5">All Identity Verifications</h3>
                    </div>
                    <!-- <div class="col-md-4">
                                    ...
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover dt-responsive"
                                                id="identity" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>
                                                        <th title="ID">ID</th>
...
<?php UnsetSession('identity_error');?>
